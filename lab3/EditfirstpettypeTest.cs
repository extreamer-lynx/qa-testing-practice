...
[TestFixture]
public class EditfirstpettypeTest {
  ...
  public void editfirstpettype() {
    ...
    driver.FindElement(By.Id("name")).SendKeys("dog smth");
    driver.FindElement(By.CssSelector(".updatePetType")).Click();
    {
      var element = driver.FindElement(By.CssSelector(".updatePetType"));
      Actions builder = new Actions(driver);
      builder.MoveToElement(element).Perform();
    }
  }
